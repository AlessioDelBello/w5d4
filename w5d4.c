...
//D sta ad indicare il valore che noi prenderemo in considerazione
    ...
    printf("Mettimi alla prova, inserisci un numero: ");
    //Questo comando ci permette di stampare il testo "Mettimi alla prova, inserisci un numero:"

    scanf("%f", &D);
    /*Questo comando ci permette di leggere il valore inserito dall utente,
     dove andremo ad inserire & prima di D per indicare che D non è un valore ma un indirizzo di memoria*/
    ...
    * si usa come simbolo moltiplicatore */
    ...
    il valore sqrt(3) sta ad indicare la radice quadrata di 3, il .2 ci permette di specificare quante cifre vogliamo dopo la virgola
    f sta ad indicare il tipo di formato del valore preso in considerazione, / sta ad indicare la divisione*/
